...
for II=6
    ...
    data0{II}=spectroscopy1_zpa('qubit',qubits{II},...
        'biasAmp',0,'driveFreq',[4e9:0.5e6:4.75e9],...
        'r_avg',500,'notes','Use Q5 XY','gui',true,'save',true,'dataTyp','S21');
...
tuneup.optReadoutAmp('qubit','q7','gui',true,'save',true,'bnd',[1000,10000],'optnum',21,'tunerf',true);
%% Optimize readout length
tuneup.optReadoutLn('qubit','q7','gui',true,'save',true,'bnd',[800,5000],'optnum',15);
%%
...
%%
T1_1('qubit','q6','biasAmp',0,'time',[0:160*2:30e3],'biasDelay',0,...
    'gui',true,'save',true,'r_avg',3000,'fit',true)
%%
T1_1('qubit','q6','biasAmp',[-30000:1e3:30000],'time',[0:160*3:30e3],'biasDelay',0,...
...
T1_1_s21('qubit','q2','biasAmp',[-3e4:1e3:3e4],'time',[0:200:10e3],...
    'gui',true,'save',true,'r_avg',5000)
%% dp
ramsey('mode','dp','qubit','q6',...
    'time',[0:16*1:1600*4],'detuning',-2e6,'T1',4.,'fit',true,...
