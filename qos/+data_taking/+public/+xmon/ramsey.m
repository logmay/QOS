...
if args.fit % Add by GM, 170623
    ...
    if size(Ramsey_data0,1)==1
        hf=figure(21);
        plot(Ramsey_time,Ramsey_data,'o',fitramsey_time,fitramsey_data,'MarkerFaceColor','r');
        title([args.qubit ' T_2^*=' num2str(T2/1e3,'%.2f') '\pm' num2str(T2_err/1e3,'%.2f') 'us, \Deltaf=' num2str(1e3*detuningf,'%.2f') '\pm' num2str(1e3*detuningf_err,'%.2f') 'MHz'])
